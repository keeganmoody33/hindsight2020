...
- Pack-local graph Context OS: Priors (not facts), no uninstrumented outcomes, send/inbox guardrails in owned skills. Taxonomy sheet still required for the 15×101 environment spine.
